	...
	r.fn.share = function(t) {
		...
		var f = r(document.head),
			c = {
				url: location.href,
				desc: '童心圆，我们在路上',
				summary: "童心圆留守儿童关爱行动项目获全国青年志愿服务示范项目创建提名奖",
				site_url: location.origin,
				source: f.find("[name=site], [name=Site]").attr("content") || document.title,
				title: f.find("[name=title], [name=Title]").attr("content") || document.title,
				description: f.find("[name=description], [name=Description]").attr("content") || "",
				image:  "127.0.0.1:8020/public_crowdfunding/img/童心圆logo（蓝）.png",
				//image: r("img:first").prop("src") || "img/奖状.jpg",
			...
			l = {
				...
				qq: "http://connect.qq.com/widget/shareqq/index.html?url={{URL}}&title={{TITLE}}&pic={{IMAGE}}&appkey={{WEIBOKEY}}&summary={{SUMMARY}}",
				tencent: "http://share.v.t.qq.com/index.php?c=share&a=index&title={{TITLE}}&url={{URL}}&pic={{IMAGE}}&summary={{SUMMARY}}",
				weibo: "http://service.weibo.com/share/share.php?url={{URL}}&title={{TITLE}}&pic={{IMAGE}}&appkey={{WEIBOKEY}}&summary={{SUMMARY}}",
				wechat: "javascript:;",
