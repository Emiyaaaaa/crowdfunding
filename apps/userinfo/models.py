...
class UserMessage(AbstractUser):
    ...
    user_mobile = models.CharField(max_length=11, verbose_name= '联系电话',null=False)
    user_qq = models.CharField(max_length=12, verbose_name= '联系QQ',null=False)
    ...
    user_hand_portrait = models.ImageField(max_length=100,verbose_name='头像',upload_to='image/%Y/%m', default=u"image/default.png", null=True)
